// MeshSelectorPlugIn.h : main header file for the MeshSelector plug-in.
//

#pragma once

// CMeshSelectorPlugIn
// See MeshSelectorPlugIn.cpp for the implementation of this class
//

class CMeshSelectorPlugIn : public CRhinoUtilityPlugIn
{
public:
  ...
  // CMeshSelectorPlugIn destructor. The destructor is called to destroy
  // "thePlugIn" when the plug-in is unloaded. Immediately before the
  // DLL is unloaded, CMeshSelectorPlugIn::OnUnloadPlugin() is called. Do
  // not do too much here. Be sure to clean up any memory you have allocated
  // with onmalloc(), onrealloc(), oncalloc(), or onstrdup().
  ~CMeshSelectorPlugIn() = default;
