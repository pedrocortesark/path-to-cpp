// GetPointsPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"GetPoints");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"C6DF199B-46C2-4051-A49C-27A75BB6229D");
...
RHINO_PLUG_IN_DESCRIPTION(L"GetPoints plug-in for Rhinoceros®");
...
// The one and only CGetPointsPlugIn object
static class CGetPointsPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CGetPointsPlugIn definition

CGetPointsPlugIn& GetPointsPlugIn()
{
	// Return a reference to the one and only CGetPointsPlugIn object
	return thePlugIn;
}

CGetPointsPlugIn::CGetPointsPlugIn()
{
	// Description:
	//   CGetPointsPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CGetPointsPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CGetPointsPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CGetPointsPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CGetPointsPlugIn::PlugInID() const
{
	// Description:
	...
	// {C6DF199B-46C2-4051-A49C-27A75BB6229D}
...
BOOL CGetPointsPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CGetPointsPlugIn::OnUnloadPlugIn()
{
	// Description:
