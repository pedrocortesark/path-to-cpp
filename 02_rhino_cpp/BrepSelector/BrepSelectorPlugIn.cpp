// BrepSelectorPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"BrepSelector");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"16653579-3648-4F80-A4B4-6FC204A49778");
...
RHINO_PLUG_IN_DESCRIPTION(L"BrepSelector plug-in for Rhinoceros®");
...
// The one and only CBrepSelectorPlugIn object
static class CBrepSelectorPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CBrepSelectorPlugIn definition

CBrepSelectorPlugIn& BrepSelectorPlugIn()
{
	// Return a reference to the one and only CBrepSelectorPlugIn object
	return thePlugIn;
}

CBrepSelectorPlugIn::CBrepSelectorPlugIn()
{
	// Description:
	//   CBrepSelectorPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CBrepSelectorPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CBrepSelectorPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CBrepSelectorPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CBrepSelectorPlugIn::PlugInID() const
{
	// Description:
	...
	// {16653579-3648-4F80-A4B4-6FC204A49778}
...
BOOL CBrepSelectorPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CBrepSelectorPlugIn::OnUnloadPlugIn()
{
	// Description:
