// CurveSelectorPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"CurveSelector");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"ADB15209-AD13-4FBC-B1D2-8E5188C63393");
...
RHINO_PLUG_IN_DESCRIPTION(L"CurveSelector plug-in for Rhinoceros®");
...
// The one and only CCurveSelectorPlugIn object
static class CCurveSelectorPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CCurveSelectorPlugIn definition

CCurveSelectorPlugIn& CurveSelectorPlugIn()
{
	// Return a reference to the one and only CCurveSelectorPlugIn object
	return thePlugIn;
}

CCurveSelectorPlugIn::CCurveSelectorPlugIn()
{
	// Description:
	//   CCurveSelectorPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CCurveSelectorPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CCurveSelectorPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CCurveSelectorPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CCurveSelectorPlugIn::PlugInID() const
{
	// Description:
	...
	// {ADB15209-AD13-4FBC-B1D2-8E5188C63393}
...
BOOL CCurveSelectorPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CCurveSelectorPlugIn::OnUnloadPlugIn()
{
	// Description:
