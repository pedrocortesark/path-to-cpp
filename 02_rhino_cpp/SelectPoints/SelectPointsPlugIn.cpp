// SelectPointsPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"SelectPoints");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"8F6F7CC0-0593-4FA6-B831-4DDC5650E9AD");
...
RHINO_PLUG_IN_DESCRIPTION(L"SelectPoints plug-in for Rhinoceros®");
...
// The one and only CSelectPointsPlugIn object
static class CSelectPointsPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CSelectPointsPlugIn definition

CSelectPointsPlugIn& SelectPointsPlugIn()
{
	// Return a reference to the one and only CSelectPointsPlugIn object
	return thePlugIn;
}

CSelectPointsPlugIn::CSelectPointsPlugIn()
{
	// Description:
	//   CSelectPointsPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CSelectPointsPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CSelectPointsPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CSelectPointsPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CSelectPointsPlugIn::PlugInID() const
{
	// Description:
	...
	// {8F6F7CC0-0593-4FA6-B831-4DDC5650E9AD}
...
BOOL CSelectPointsPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CSelectPointsPlugIn::OnUnloadPlugIn()
{
	// Description:
