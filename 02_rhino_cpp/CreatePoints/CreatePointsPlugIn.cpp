// CreatePointsPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"CreatePoints");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"0B2B037A-D561-4477-B94E-2128DE9F9073");
...
RHINO_PLUG_IN_DESCRIPTION(L"CreatePoints plug-in for Rhinoceros®");
...
// The one and only CCreatePointsPlugIn object
static class CCreatePointsPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CCreatePointsPlugIn definition

CCreatePointsPlugIn& CreatePointsPlugIn()
{
	// Return a reference to the one and only CCreatePointsPlugIn object
	return thePlugIn;
}

CCreatePointsPlugIn::CCreatePointsPlugIn()
{
	// Description:
	//   CCreatePointsPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CCreatePointsPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CCreatePointsPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CCreatePointsPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CCreatePointsPlugIn::PlugInID() const
{
	// Description:
	...
	// {0B2B037A-D561-4477-B94E-2128DE9F9073}
...
BOOL CCreatePointsPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CCreatePointsPlugIn::OnUnloadPlugIn()
{
	// Description:
