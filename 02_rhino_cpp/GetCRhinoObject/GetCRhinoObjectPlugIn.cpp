// GetCRhinoObjectPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"GetCRhinoObject");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"AF48BBF7-148F-4A3D-B1FC-950CD22F72F9");
...
RHINO_PLUG_IN_DESCRIPTION(L"GetCRhinoObject plug-in for Rhinoceros®");
...
// The one and only CGetCRhinoObjectPlugIn object
static class CGetCRhinoObjectPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CGetCRhinoObjectPlugIn definition

CGetCRhinoObjectPlugIn& GetCRhinoObjectPlugIn()
{
	// Return a reference to the one and only CGetCRhinoObjectPlugIn object
	return thePlugIn;
}

CGetCRhinoObjectPlugIn::CGetCRhinoObjectPlugIn()
{
	// Description:
	//   CGetCRhinoObjectPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CGetCRhinoObjectPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CGetCRhinoObjectPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CGetCRhinoObjectPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CGetCRhinoObjectPlugIn::PlugInID() const
{
	// Description:
	...
	// {AF48BBF7-148F-4A3D-B1FC-950CD22F72F9}
...
BOOL CGetCRhinoObjectPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CGetCRhinoObjectPlugIn::OnUnloadPlugIn()
{
	// Description:
